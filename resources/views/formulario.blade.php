...
<section class="section">
      ...
      <div class="col">
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{ route('admin.formulario.formulario_send')}}" id="payment-form">
                  {{ csrf_field() }}
                    ...
                    <div class="pymnt-itm card active">
                        <div class="pymnt-cntnt">
                            <div class='method-card' id='method-card'>
                              ...
                              <br>
                              <button type="button" class='method-card__button' onclick="pagar(event)">
                                Pagar
                              </button>
                            </div>
                        </div>
    ...
    <style>
        ...
        .toast {
            border-radius: .375rem; /* Radio de borde */
